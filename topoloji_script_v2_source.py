...
accountListSSH = [
    ...
    {
            'name': 'hmbadminnetwork',
            'port': 22,
            'username': 'hmbadminnetwork',
            'password': '!**H@zine+M@liye2023**!',
            'device_type': 'cisco_ios',
            'verbose': True
    },
    {
